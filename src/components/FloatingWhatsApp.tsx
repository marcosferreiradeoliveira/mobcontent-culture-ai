...
const WHATSAPP_URL = "https://wa.me/5521966225632?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20os%20servi%C3%A7os%20da%20mobCONTENT.";
...
/* Ícone oficial WhatsApp: telefone na bolha de conversa */
const WhatsAppIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0">
...
export const FloatingWhatsApp = () => (
  <a
    ...
    className="fixed bottom-6 right-6 z-[100] flex items-center gap-2 px-4 py-3 bg-[#25D366] hover:bg-[#20BD5A] text-white rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 font-semibold text-sm"
